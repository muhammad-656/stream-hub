      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            <h3 className="text-2xl font-bold text-red-600 mb-4">StreamHub</h3>
            <p className="text-gray-400 mb-4">
              Your ultimate destination for streaming the latest and greatest videos. Discover, watch, and enjoy content from around the world.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-gray-400">Get the latest updates and exclusive content delivered to your inbox.</p>
            </div>
